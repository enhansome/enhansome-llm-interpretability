...
2. [Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,135 | 🐛 944 | 🌐 Python | 📅 2026-08-21 - AI Observability & Evaluation - Evaluate, troubleshoot, and fine tune your LLM, CV, and NLP models in a notebook.
3. [TransformerLens](https://github.com/neelnanda-io/TransformerLens) ⭐ 3,805 | 🐛 19 | 🌐 Python | 📅 2026-08-21 - A Library for Mechanistic Interpretability of Generative Language Models.
4. [Pythia](https://github.com/EleutherAI/pythia) ⭐ 2,896 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-11-15 - Interpretability analysis to understand how knowledge develops and evolves during training in autoregressive transformers.
...
8. [Rome](https://github.com/kmeng01/rome) ⭐ 774 | 🐛 25 | 🌐 Python | 📅 2024-04-20 - Locating and editing factual associations in GPT.
...
13. [Sparse Autoencoder](https://github.com/ai-safety-foundation/sparse_autoencoder) ⭐ 302 | 🐛 15 | 🌐 Python | 📅 2024-07-20 - Sparse Autoencoder for Mechanistic Interpretability.
...
Please see [CONTRIBUTING](https://github.com/JShollaj/awesome-llm-interpretability/blob/master/CONTRIBUTING.md) ⭐ 1,642 | 🐛 6 | 📅 2026-08-11 and [CODE-OF-CONDUCT](https://github.com/JShollaj/awesome-llm-interpretability/blob/master/CODE-OF-CONDUCT.md) ⭐ 1,642 | 🐛 6 | 📅 2026-08-11 for details.
