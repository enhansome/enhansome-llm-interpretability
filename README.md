...
2. [Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,292 | 🐛 951 | 🌐 Python | 📅 2026-09-02 - AI Observability & Evaluation - Evaluate, troubleshoot, and fine tune your LLM, CV, and NLP models in a notebook.
3. [TransformerLens](https://github.com/neelnanda-io/TransformerLens) ⭐ 3,840 | 🐛 11 | 🌐 Python | 📅 2026-09-02 - A Library for Mechanistic Interpretability of Generative Language Models.
4. [Pythia](https://github.com/EleutherAI/pythia) ⭐ 2,917 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-11-15 - Interpretability analysis to understand how knowledge develops and evolves during training in autoregressive transformers.
...
13. [Sparse Autoencoder](https://github.com/ai-safety-foundation/sparse_autoencoder) ⭐ 305 | 🐛 15 | 🌐 Python | 📅 2024-07-20 - Sparse Autoencoder for Mechanistic Interpretability.
