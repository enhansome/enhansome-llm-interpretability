...
2. [Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,625 | 🐛 1,093 | 🌐 Python | 📅 2026-09-26 - AI Observability & Evaluation - Evaluate, troubleshoot, and fine tune your LLM, CV, and NLP models in a notebook.
3. [TransformerLens](https://github.com/neelnanda-io/TransformerLens) ⭐ 3,911 | 🐛 22 | 🌐 Python | 📅 2026-09-25 - A Library for Mechanistic Interpretability of Generative Language Models.
4. [Pythia](https://github.com/EleutherAI/pythia) ⭐ 2,946 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-11-15 - Interpretability analysis to understand how knowledge develops and evolves during training in autoregressive transformers.
...
12. [Awesome-Attention-Heads](https://github.com/IAAR-Shanghai/Awesome-Attention-Heads) ⭐ 415 | 🐛 4 | 🌐 TeX | 📅 2025-03-02 - A carefully compiled list that summarizes the diverse functions of the attention heads.
...
Please see [CONTRIBUTING](https://github.com/JShollaj/awesome-llm-interpretability/blob/master/CONTRIBUTING.md) ⭐ 1,650 | 🐛 7 | 📅 2026-08-11 and [CODE-OF-CONDUCT](https://github.com/JShollaj/awesome-llm-interpretability/blob/master/CODE-OF-CONDUCT.md) ⭐ 1,650 | 🐛 7 | 📅 2026-08-11 for details.
