...
2. [Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,123 | 🐛 946 | 🌐 Python | 📅 2026-08-20 - AI Observability & Evaluation - Evaluate, troubleshoot, and fine tune your LLM, CV, and NLP models in a notebook.
3. [TransformerLens](https://github.com/neelnanda-io/TransformerLens) ⭐ 3,804 | 🐛 20 | 🌐 Python | 📅 2026-08-20 - A Library for Mechanistic Interpretability of Generative Language Models.
4. [Pythia](https://github.com/EleutherAI/pythia) ⭐ 2,886 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-11-15 - Interpretability analysis to understand how knowledge develops and evolves during training in autoregressive transformers.
