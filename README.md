...
2. [Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,514 | 🐛 1,004 | 🌐 Python | 📅 2026-09-17 - AI Observability & Evaluation - Evaluate, troubleshoot, and fine tune your LLM, CV, and NLP models in a notebook.
3. [TransformerLens](https://github.com/neelnanda-io/TransformerLens) ⭐ 3,878 | 🐛 14 | 🌐 Python | 📅 2026-09-16 - A Library for Mechanistic Interpretability of Generative Language Models.
4. [Pythia](https://github.com/EleutherAI/pythia) ⭐ 2,935 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-11-15 - Interpretability analysis to understand how knowledge develops and evolves during training in autoregressive transformers.
...
12. [Awesome-Attention-Heads](https://github.com/IAAR-Shanghai/Awesome-Attention-Heads) ⭐ 414 | 🐛 4 | 🌐 TeX | 📅 2025-03-02 - A carefully compiled list that summarizes the diverse functions of the attention heads.
...
Please see [CONTRIBUTING](https://github.com/JShollaj/awesome-llm-interpretability/blob/master/CONTRIBUTING.md) ⭐ 1,646 | 🐛 6 | 📅 2026-08-11 and [CODE-OF-CONDUCT](https://github.com/JShollaj/awesome-llm-interpretability/blob/master/CODE-OF-CONDUCT.md) ⭐ 1,646 | 🐛 6 | 📅 2026-08-11 for details.
